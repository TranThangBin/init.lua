return {
	...
	config = function(_, opts)
		require("lsp-zero").on_attach(function(client, bufnr)
			...
			vim.keymap.set("n", "<leader>ws", builtin.lsp_workspace_symbols, remap_opts)
			vim.keymap.set("n", "<leader>ds", builtin.lsp_document_symbols, remap_opts)
			...
			vim.keymap.set("n", "<leader>ca", vim.lsp.buf.code_action, remap_opts)
			vim.keymap.set("n", "<leader>rn", vim.lsp.buf.rename, remap_opts)
