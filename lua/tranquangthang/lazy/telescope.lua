return {
	...
	config = function(_, opts)
		...
		vim.keymap.set("n", "<leader>tf", builtin.find_files, { desc = "Telescope: [t]elescope [f]iles" })
		vim.keymap.set("n", "<leader>tg", builtin.git_files, { desc = "Telescope: [t]elescope [g]it files" })
		vim.keymap.set("n", "<leader>tb", builtin.buffers, { desc = "Telescope: [t]elescope [b]uffers" })
